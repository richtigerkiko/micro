# https://github.com/carlesfg/MicroPython/blob/CO2-Sensor/MHZ19B.py
...
class mhz19b:
    ...
    def __init__(self,rx_pin: int, tx_pin: int):
        ...
        #swapped tx und rx wegen UART tooltip, ggf zurückswappen, partiy=0 ggf parity=None
        self.uart = UART(1, baudrate=9600, bits=8, parity=0, stop=1, rx=Pin(tx_pin) ,tx=Pin(rx_pin))
    ...
    def measure(self):
        while True:
            ...
            time.sleep_ms(1000)  # in miliseconds
